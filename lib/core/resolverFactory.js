...
function getConstructor(source, config, registryClient, logger) {
    ...
    if(resolverPrefix) {
        var resolverName = 'bower-' + resolverPrefix + '-resolver';
        try {
            var pkgResolver = require(resolverName);
            ...
            return Q.fcall(function () {
             ...
             logger.warn('resolver-plugin', 'Could not find package ' + resolverName + '. Make sure you installed it (npm install -g ' + resolverName + ').');
        }
    }
